...
declare namespace Serene1.Modules.Default.Movie {
    enum MovieKind {
        Film = 1,
        TvSeries = 2,
        MiniSeries = 3
...
declare namespace Serene1.Default {
    class MovieCastEditDialog extends Serene1.Common.GridEditorDialog<MovieCastRow> {
        protected getFormKey(): string;
        protected getNameProperty(): string;
        protected getLocalTextPrefix(): string;
        protected form: MovieCastForm;
...
declare namespace Serene1.Default {
    class MovieCastEditor extends Serene1.Common.GridEditorBase<MovieCastRow> {
        protected getColumnsKey(): string;
        protected getLocalTextPrefix(): string;
