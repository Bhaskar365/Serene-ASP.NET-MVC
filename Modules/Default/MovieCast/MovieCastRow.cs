...
namespace Serene1.Default.Entities
{
    ...
    public sealed class MovieCastRow : Row, IIdRow, INameRow
    {
        ...
        //[DisplayName("Person"), NotNull, 
        //    ForeignKey("[dbo].[Person]", "PersonId"), 
        ...
        [ForeignKey("[dbo].[Person]", "PersonId"), LeftJoin("jPerson")]
        [LookupEditor(typeof(PersonRow))] // Note: Removed 'Async = true' as it's not in legacy
        public Int32? PersonId
        {
            get { return Fields.PersonId[this]; }
            set { Fields.PersonId[this] = value; }
        ...
        // Add PersonFullName (This replaces the need for PersonFirstName/LastName in the grid)
